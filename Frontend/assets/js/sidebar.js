document.addEventListener("DOMContentLoaded", function() {
    ...
    const sidebarHTML = `
        <div class="sidebar d-flex flex-column p-0">
            ...
            <a href="${basePath}auditoria_QR/auditoria.html" data-page="auditoria"><i class="bi bi-qr-code-scan"></i> Auditoría QR</a>
            <a href="${basePath}prestamos_devoluciones/devoluciones.html" data-page="devoluciones"><i class="bi bi-arrow-left-right"></i> Préstamos y Devoluciones</a>
            <a href="${basePath}reportes/reportes.html" data-page="reportes"><i class="bi bi-file-earmark-medical"></i> Reportes</a>
            
            <div class="px-3 py-2 text-muted small fw-bold mt-2" style="font-size: 0.7rem; letter-spacing: 1px;">SISTEMA</div>
            <a href="${basePath}gestion_usuarios/usuarios.html" data-page="usuarios"><i class="bi bi-people"></i> Usuarios</a>
